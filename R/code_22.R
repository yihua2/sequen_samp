...
d1d <- opt_design(theta_stg1 ,n=500,pp=0,space)
...
which.max(pnorm(X%*%theta_hat_pos))
#[1] 22
...
dat[which.max(fitted.values(fit)),]$config # 77??
...
save.image("/Users/Vera/Dropbox/study/google/code_22img.RData")
